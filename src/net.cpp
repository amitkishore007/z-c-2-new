...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Zedexcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"zedexcointools.org", "198.199.67.16"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"zedexcointools.com", "testnet-seed.zedexcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zedexcoin is probably already running."), addrBind.ToString().c_str());
        else
